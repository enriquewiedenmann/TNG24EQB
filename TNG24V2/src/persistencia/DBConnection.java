...
public class DBConnection {
	...
	public static DBConnection getPoolConnection() {
		if (pool == null)
			pool = new DBConnection();
		return pool;
	}
	...
	public Connection getConnection() {
		...
		if (connections.size() > 0)
			...
			c = connect();
			System.out
					.println("Se ha creado una nueva conexion fuera de los parametros de configuracion. cantidad de conexiones: "
							+ connections.size());
		}
		return c;
	}
