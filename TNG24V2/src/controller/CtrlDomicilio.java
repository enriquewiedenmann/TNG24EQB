...
public class CtrlDomicilio {
	...
	public CodigoPostal bucarCodigosPostal(int id, String cod, String desc,
			String codProv, String codCiudad, char e) {
		return null;
	}

	public Domicilio buscarDomicilio(int id, String calle, String nro,
			String piso, String dpto, String tel, String prov, String cdad,
			String cp, String desc) {
	...
	public Ciudad buscarCiudad(int id, String cod, String desc, String codProv,
			char e) {
		return null;
	}
