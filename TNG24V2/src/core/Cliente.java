...
public class Cliente extends Ente {
	...
	public Cliente(String nombre, String apellido, String nroDoc,
			TipoDocumento tipoDoc, String telefono, String mail,
			Domicilio domicilio) {
		...
		this.setIdEnte(c.insert(nombre, apellido, tipoDoc.getCodTipoDoc(),
				nroDoc, telefono, mail, domicilio.getIdDomicilio()));
	...
	public boolean cumplo(int id, String nombre, String apellido,
			String documento) {

		return this.getIdEnte() == id
				&& this.cumplo(nombre, apellido, documento);
	...
	public ViewCliente mostrate() {
		ViewCliente vc = new ViewCliente(this.getIdEnte(), this.getNombre(),
				this.getApellido(), this.getTipoDoc(), this.getNroDoc(),
				this.getEstado(), this.getTelefono(), this.getMail(),
				this.getDomicilio());
		return vc;

	}

	public void editate(String apellido, String nombre, String documento,
			TipoDocumento codDoc, String tel, String mail, Domicilio dom) {
